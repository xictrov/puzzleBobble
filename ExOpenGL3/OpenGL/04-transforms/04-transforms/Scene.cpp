...
void Scene::render()
{
	...
	modelview = glm::translate(modelview, glm::vec3(cos(currentTime/200)*50, 0.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	...
	modelview = glm::translate(modelview, glm::vec3(64.f, 64.f, 0.f));
	modelview = glm::translate(modelview, glm::vec3(cos(currentTime / 200) * 50, 0.0f, 1.0f));
	modelview = glm::scale(modelview, glm::vec3(abs(sin(currentTime / 200)), abs(sin(currentTime / 200)), 1));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	program.setUniformMatrix4f("modelview", modelview);
	quad->render();
